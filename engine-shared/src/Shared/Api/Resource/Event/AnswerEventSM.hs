...
instance ToSchema AddAnswerEventDTO where
  declareNamedSchema = simpleToSchema'' "_addAnswerEventDTO" "type" (toDTO a_km1_ch1_q2_aNo1)

instance ToSchema EditAnswerEventDTO where
  declareNamedSchema = simpleToSchema'' "_editAnswerEventDTO" "type" (toDTO e_km1_ch1_q2_aYes1)

instance ToSchema DeleteAnswerEventDTO where
  declareNamedSchema = simpleToSchema'' "_deleteAnswerEventDTO" "type" (toDTO d_km1_ch1_q2_aYes1)
