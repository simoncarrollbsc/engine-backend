...
instance ToSchema MoveQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_moveQuestionEventDTO" "type" (toDTO m_km1_ch1_q1__to_ch2)

instance ToSchema MoveAnswerEventDTO where
  declareNamedSchema = simpleToSchema'' "_moveAnswerEventDTO" "type" (toDTO m_km1_ch1_q2_aYes__to_ch2_q3)

instance ToSchema MoveExpertEventDTO where
  declareNamedSchema = simpleToSchema'' "_moveExpertEventDTO" "type" (toDTO m_km1_ch1_q2_eAlbert__to_ch2_q3)
