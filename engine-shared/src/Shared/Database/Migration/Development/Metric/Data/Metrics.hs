...
metricF =
  Metric
    { _uuid = fromJust . U.fromString $ "8db30660-d4e5-4c0a-bf3e-553f3f0f997a"
    , _title = "Findability"
    , _abbreviation = Just "F"
    , _description =
        Just
...
metricA =
  Metric
    { _uuid = fromJust . U.fromString $ "0feac7e6-add4-4723-abae-be5ce7864c63"
    , _title = "Accessibility"
    , _abbreviation = Just "A"
    , _description =
        Just
...
metricI =
  Metric
    { _uuid = fromJust . U.fromString $ "a42bded3-a085-45f8-b384-32b4a77c8385"
    , _title = "Interoperability"
    , _abbreviation = Just "I"
    , _description =
        Just
...
metricR =
  Metric
    { _uuid = fromJust . U.fromString $ "0bafe0c2-a8f2-4c74-80c8-dbf3a5b8e9b7"
    , _title = "Reusability"
    , _abbreviation = Just "R"
    , _description =
        Just
...
metricG =
  Metric
    { _uuid = fromJust . U.fromString $ "8845fe2b-79df-4138-baea-3a035bf5e249"
    , _title = "Good DMP Practice"
    , _abbreviation = Just "G"
    , _description =
        Just
...
metricO =
  Metric
    { _uuid = fromJust . U.fromString $ "cc02c5a0-9754-4432-a7e0-ce0f3cf7a0a0"
    , _title = "Openness"
    , _abbreviation = Just "O"
    , _description =
        Just
...
mm1 :: MetricMeasure
mm1 =
  MetricMeasure {_metricUuid = metricF ^. uuid, _measure = 0.4, _weight = 0.5}
