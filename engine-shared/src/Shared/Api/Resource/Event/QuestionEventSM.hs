...
instance ToSchema AddOptionsQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_addOptionsQuestionEventDTO" "type" (toDTO a_km1_ch1_q2')

instance ToSchema AddListQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_addListQuestionEventDTO" "type" (toDTO a_km1_ch2_q4')

instance ToSchema AddValueQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_addValueQuestionEventDTO" "type" (toDTO a_km1_ch1_q1')

instance ToSchema AddIntegrationQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_addIntegrationQuestionEventDTO" "type" (toDTO a_km1_ch3_q9')
...
instance ToSchema EditOptionsQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_editOptionsQuestionEventDTO" "type" (toDTO e_km1_ch1_q2')

instance ToSchema EditListQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_editListQuestionEventDTO" "type" (toDTO e_km1_ch2_q4')

instance ToSchema EditValueQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_editValueQuestionEventDTO" "type" (toDTO e_km1_ch1_q1')

instance ToSchema EditIntegrationQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_editIntegrationQuestionEventDTO" "type" (toDTO e_km1_ch3_q9')

-- --------------------------------------------
-- --------------------------------------------
instance ToSchema DeleteQuestionEventDTO where
  declareNamedSchema = simpleToSchema'' "_deleteQuestionEventDTO" "type" (toDTO d_km1_ch1_q1)
